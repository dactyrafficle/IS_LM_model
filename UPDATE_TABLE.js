function UPDATE_TABLE(ECONOMIC_OUTPUT) {
  ...
  document.getElementById('state_a_Y_LM').value = ((a.M/(a.gamma*a.P))**(1/a.epsilon)*a.r**(a.theta/a.epsilon)).toFixed(2);
  ...
  document.getElementById('state_b_Y_LM').value = ((b.M/(b.gamma*b.P))**(1/b.epsilon)*b.r**(b.theta/b.epsilon)).toFixed(2);
}